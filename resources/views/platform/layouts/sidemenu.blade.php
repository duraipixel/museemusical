        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-sub menu-sub-accordion menu-active-bg">
                    <div class="menu-item">
                        <a class="menu-link" href="../authentication/extended/multi-steps-sign-up.html">
                            ...
                            <span class="menu-title">Set Level</span>
                        </a>
                    </div>
                    <div class="menu-item">
                        <a class="menu-link" href="../authentication/extended/two-factor-authentication.html">
                            ...
                            <span class="menu-title">Level Approval</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="../apps/projects/targets.html">
                            ...
                            <span class="menu-title">Approve Project</span>
                        </a>
                    </div>
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                <span class="menu-link">
                    ...
                    <span class="menu-title">Walk Through History</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">

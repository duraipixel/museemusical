        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">Testimonials List</li>
                </ul>
        ...
        <div class="card">
            <div class="card-header border-0 pt-6 w-100">
                <div class="card-toolbar w-100">
                    <div class="d-flex justify-content-end w-100" data-kt-testimonials-table-toolbar="base">
                                ...
                                <form id="search-form">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select name="filter_status" class="form-select form-select-solid fw-bolder"
                                            ...
                                            data-kt-testimonials-table-filter="order" data-hide-search="true">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-primary fw-bold px-6"
                                            data-kt-menu-dismiss="true" data-kt-testimonials-table-filter="filter">Apply</button>
                                    </div>
                                </form>
                            </div>
                        </div>

                        <button type="button" class="btn btn-light-primary me-3" onclick="return openExportForm('testimonials')">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">
                        ...
                        <button type="button" class="btn btn-primary" onclick="return openForm('testimonials')">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">
            ...
            <div class="card-body py-4">
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-2 mb-0 dataTable no-footer" id="testimonials-table">
                        <thead>
...
@section('add_on_script')
    ...
    <script>
        var dtTable = $('#testimonials-table').DataTable({

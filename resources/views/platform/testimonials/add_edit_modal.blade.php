                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            <label class="fw-bold fs-6 mb-2">Long Discription</label>
                                <textarea class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Long Discription" name="long_description" id="long_description" cols="30" rows="5">{{ $info->long_description ?? '' }}</textarea>
                        </div>

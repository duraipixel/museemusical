    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Country List</h1>
                ...
                <div class="card-toolbar w-100">
                    <div class="d-flex justify-content-end w-100" data-kt-country-table-toolbar="base">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                            ...
                            <div class="px-7 py-5" data-kt-country-table-filter="form">
                                <form id="search-form">
                                    <!--begin::Input group-->
                                    <div class="mb-10">
                                        ...
                                        <select name="filter_status" class="form-select form-select-solid fw-bolder"
                                            ...
                                            data-kt-country-table-filter="order" data-hide-search="true">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset"
                                            ...
                                            data-kt-menu-dismiss="true" data-kt-country-table-filter="reset">Reset</button>
                                        <button type="submit" class="btn btn-primary fw-bold px-6"
                                            data-kt-menu-dismiss="true" data-kt-country-table-filter="filter">Apply</button>
                                    </div>
                                </form>
                            </div>
                        </div>

                        <button type="button" class="btn btn-light-primary me-3" onclick="return openExportForm('country')">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">
                        ...
                        <button type="button" class="btn btn-primary" onclick="return openForm('country')">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none">

...
<!--end::Header-->
<!--begin::Body-->
<form id="add_country_form" class="form" action="#" enctype="multipart/form-data">
            ...
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll">
                <div class="fv-row mb-10">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">ISO</label>
                            <input type="text" name="iso" maxlength="3" class="form-control form-control-solid mb-3 mb-lg-0"
                                placeholder="Iso" value="{{ $info->iso ?? '' }}" />
                        </div>
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">Phone Code</label>
                            <input type="text" name="phone_code" maxlength="2" class="form-control form-control-solid mb-3 mb-lg-0 mobile_num"
                                placeholder="Phone Code" value="{{ $info->phone_code ?? '' }}" />
                        </div>
                        <div class="fv-row mb-7">
                            <label class="fw-bold fs-6 mb-2">ISO 3</label>
                            <input type="text" name="iso3" maxlength="3" class="form-control form-control-solid mb-3 mb-lg-0"
                                placeholder="Iso 3" value="{{ $info->iso3 ?? '' }}" />
                        </div>
                        <div class="fv-row mb-7">
                            <label class="fw-bold fs-6 mb-2">Number Code</label>
...
<script>
 $('.mobile_num').keypress(
    ...
    var add_url = "{{ route('country.save') }}";

    // Class definition
    var KTUsersAddRole = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_country_form');

...
<!--end::Header-->
<!--begin::Body-->
<form id="add_state_form" class="form" action="#" enctype="multipart/form-data">
                ...
                <div class="fv-row mb-10">
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                        ...
                        <div class="d-flex flex-column mb-7 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <select name="country_id" id="country_id" aria-label="Select a Country" class="form-select form-select-solid fw-bolder">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="state_name" class="form-control form-control-solid mb-3 mb-lg-0"
                                placeholder="State Name" value="{{ $info->state_name ?? '' }}" />
                        </div>
                        <div class="fv-row mb-7">
...
<script>
 ...
 $('.mobile_num').keypress(
    ...
    var add_url = "{{ route('state.save') }}";

    // Class definition
    var KTUsersAddRole = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_state_form');

            ...
            <td style="width: 50%;">
                <table class="no-border" cellspacing="0" padding="0" style="width: 100%;">
                    <tr>
                        ...
                        <td style="text-align: right">&#8377; {{ number_format($order_info->sub_total, 2) }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: right">Tax (%{{ number_format($order_info->tax_percentage) }}) </td>
                        <td style="text-align: right">₹{{ number_format($order_info->tax_amount, 2) }}</td>
                    </tr>
                    @if ($order_info->coupon_amount > 0)
                        <tr>
                            ...
                            <td style="text-align: right">₹{{ number_format($order_info->coupon_amount, 2) }}</td>
                        </tr>
                    @endif
                    ...
                    @if ($order_info->discount_amount > 0)
                        <tr>
                            ...
                            <td style="text-align: right">₹{{ number_format($order_info->discount_amount, 2) }}</td>
                        </tr>
                    @endif
                    @if ($order_info->shipping_amount > 0)
                        <tr>
                            ...
                            <td style="text-align: right">₹{{ number_format($order_info->shipping_amount, 2) }}</td>
                        </tr>
                    @endif
                    <tr>
                        ...
                        <td style="text-align: right;font-weight:700;font-size:15px;">
                            ₹{{ number_format($order_info->amount, 2) }}</td>
                    </tr>
                    <tr>

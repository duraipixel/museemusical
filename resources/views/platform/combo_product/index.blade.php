        ...
        <div class="card">
            <div class="card-header border-0 pt-6 w-100">
                <div class="card-toolbar w-100">
                    <div class="d-flex justify-content-end w-100" data-kt-product_attribute-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" onclick="return openForm('combo-product')">
            ...
            <div class="card-body py-4">
                <div class="table-responsive">
                    <table class="table align-middle table-row-dashed fs-6 gy-2 mb-0 dataTable no-footer" id="combo_product-table">
                        <thead>
...
@section('add_on_script')
    ...
    <script>
        var dtTable = $('#combo_product-table').DataTable({

            processing: true,
            serverSide: true,
            type: 'POST',
            ajax: {
                "url": "{{ route('combo-product') }}",
                "data": function(d) {

                                ...
                                <form id="search-form">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <select name="filter_status" class="form-select form-select-solid fw-bolder"
                                            ...
                                            data-kt-product-table-filter="order" data-hide-search="true">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset"
                                            ...
                                            data-kt-menu-dismiss="true" data-kt-product-table-filter="reset">Reset</button>
                                        <button type="submit" class="btn btn-primary fw-bold px-6"
                                            data-kt-menu-dismiss="true" data-kt-product-table-filter="filter">Apply</button>
                                    </div>
                                </form>
                            </div>
                        </div>

...
<!--end::Header-->
<!--begin::Body-->
<form id="add_quick_link_form" class="form" action="#" enctype="multipart/form-data">
...
<script>
    ...
    var add_url = "{{ route('quick-link.save') }}";

    // Class definition
    var KTUsersAddQuickLink = function() {
        // Shared variables
        const element = document.getElementById('kt_common_add_form');
        const form = element.querySelector('#add_quick_link_form');
        ...
        var initAddQuickLink = () => {
            ...
            $('#add_quick_link_form').submit(function(e) {
                ...
                if (validator) {
                    validator.validate().then(function(status) {
                        if (status == 'Valid') {
                            var from = $('#from').val();
                            var formData = new FormData(document.getElementById("add_quick_link_form"));
